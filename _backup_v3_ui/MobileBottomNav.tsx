...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({ currentPath, onNavigate }) => {
    ...
    // Use only top 4 items for bottom bar to avoid overcrowding
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden">
            ...
            >
                <style>{`.dark .mobile-bottom-nav-glass { background: rgba(15,23,42,0.78) !important; }`}</style>
                <div className="mobile-bottom-nav-glass rounded-2xl">
