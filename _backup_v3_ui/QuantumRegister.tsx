...
export function QuantumRegister<T extends { id?: string | number }>({
    ...
    return (
        <div className="flex flex-col w-full bg-white dark:bg-[#0a0f1c] border border-slate-200 dark:border-white/10 rounded-2xl shadow-lg dark:shadow-2xl overflow-hidden ring-1 ring-slate-200/50 dark:ring-black/50 transition-colors">
            {/* ═══ Command Header ═══ */}
            <div className="p-5 md:p-6 bg-gradient-to-b from-slate-50 dark:from-slate-900/80 to-transparent border-b border-slate-200 dark:border-white/5 flex flex-col xl:flex-row xl:items-end justify-between gap-5">
                <div>
            ...
            <div className={clsx("w-full overflow-auto custom-scrollbar relative bg-white dark:bg-[#060a14] transition-colors", heightClass)}>
                <table className="w-full text-left border-collapse whitespace-nowrap min-w-max">
                    <thead className="sticky top-0 z-20">
                        <tr className="bg-slate-50 dark:bg-[#0f172a] shadow-[0_1px_3px_rgba(0,0,0,0.06)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
                            {visibleColumns.map((col) => (
                                <th 
                                    ...
                                    className={clsx(
                                        ...
                                        (col.sortable !== false) && "cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-700 dark:hover:text-slate-200 transition-colors",
                                        sortConfig?.key === col.key && "text-blue-600 dark:text-blue-400 bg-blue-50/50 dark:bg-blue-900/20"
                                    )}
                                ...
                                paginatedData.map((item, rowIdx) => (
                                    <motion.tr 
                                        ...
                                        className={clsx(
                                            ...
                                            rowIdx % 2 === 0
                                                ? "bg-transparent hover:bg-blue-50/50 dark:hover:bg-white/[0.03]"
                                                : "bg-slate-50/50 dark:bg-white/[0.015] hover:bg-blue-50/50 dark:hover:bg-white/[0.04]"
                                        )}
                                    >
                                        {visibleColumns.map((col, colIdx) => (
                                            <td 
                                                ...
                                                className={clsx(
                                                    ...
                                                    col.align === 'right' ? 'text-right' : col.align === 'center' ? 'text-center' : 'text-left',
                                                    colIdx === 0 && "bg-white dark:bg-[#060a14] group-hover:bg-blue-50/50 dark:group-hover:bg-[#0f172a] sticky left-0 z-10 border-r border-slate-100 dark:border-slate-800/50 shadow-[2px_0_8px_rgba(0,0,0,0.04)] dark:shadow-[4px_0_10px_rgba(0,0,0,0.2)]"
                                                )}
                                            >
                                                {renderCell(item, col)}
                                            </td>
                    ...
                    {processedData.length > 0 && Object.keys(totals).length > 0 && (
                        <tfoot className="sticky bottom-0 z-20 bg-slate-50 dark:bg-slate-900 border-t-2 border-blue-500/20 dark:border-blue-500/30 shadow-[0_-4px_12px_rgba(0,0,0,0.04)] dark:shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
                            <tr>
