    ...
    return (
        ...
        >
            ...
            <div className="p-3 border-t border-slate-100">
                ...
                >
                    <div className="w-8 h-8 rounded-xl bg-slate-100 group-hover:bg-rose-100 flex items-center justify-center transition-colors flex-shrink-0">
                        <LogOut
                            size={15}
                    ...
                    <div>
                        <p className="text-[13px] font-bold text-slate-600 group-hover:text-rose-700 transition-colors leading-tight">
                            Sign Out
                        </p>
                        <p className="text-[10px] text-slate-400 font-medium">End Session</p>
                    </div>
                </motion.button>
            </div>
        </aside>
